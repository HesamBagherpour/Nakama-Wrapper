...
namespace Emaj_Game.NakamaWrapper.Scripts.Runtime.Controllers.Match
{
    public class MatchOpCodeController
    {
        ...
        public async UniTask<long> RegisterOpCode(string key,UnityAction<long, string, IMatchState> callback,long opCode = 0)
        {
            ...
            await matchMessageController.SendMatchState(500, new OpCodeRegister(key, opCode).ToJson());
