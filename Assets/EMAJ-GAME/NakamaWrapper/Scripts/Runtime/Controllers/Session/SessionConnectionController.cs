...
namespace Emaj_Game.NakamaWrapper.Scripts.Runtime.Controllers.Session
{
    public class SessionConnectionController : MonoBehaviour
    {
        ...
        public void Init(EM_Client client, EM_Session session, bool sessionConnectionStart, int durationInSeconds = 2,
